...
name: meme-marketing
description: >
  Dynamic agentic router and creative meme engine to craft, critique, localize,
  tune, and render highly relatable social memes from audience-specific micro-moments.
  Use when the user asks to create memes, organic social humor, reaction cards,
  screenshot memes, Egyptian or Gulf Arabic memes, B2B/tech humor, or content calendars.
